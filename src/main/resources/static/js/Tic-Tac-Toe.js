...
let Xs = $('#X');
let Ys = $('#Y');
let SingleWin = $('#SingleWin');
let SingleLoss = $('#SingleLoss');
let Draw = $('#Draw');
...
$(document).ready(function () {
    function saveGame(winner, winnerValue) {
        winnerValue = winnerValue + 1;
        winner.val(winnerValue);
    }
